local function set_bot_photo(msg, success, result)
  ...
  if success then
    ...
    send_large_msg(receiver, '<b>Photo changed!</b>', ok_cb, false)
    redis:del("bot:photo")
  else
...
local function run(msg,matches)
    ...
    if matches[1] == "markread" then
    	if matches[2] == "on" then
    		...
    		return "<b>Mark read > on</b>"
    	end
    	if matches[2] == "off" then
    		redis:del("bot:markread")
    		return "<b>Mark read > off</b>"
    	end
    	return
    end
    ...
    if matches[1] == "pmblock" then
    	if is_admin2(matches[2]) then
    		return "<b>You can't block admins</b>"
    	end
    ...
    if matches[1] == "delcontact" then
      ...
      return "<b>User "..matches[2].." removed from contact list</b>"
    end
   ...
   return "<b>User With Phone +"..matches[2].." has been added</b>"
end
 ...
 if matches[1] == "mycontact" and is_sudo(msg) then
	if not msg.from.phone then
		return "<b>I must Have Your Phone Number!</b>"
    end
	...
	if matches[1] == 'reload' then
		...
		reload_plugins(true)
		post_msg(receiver, "<b>Reloaded!</b>", ok_cb, false)
		return "<b>Reloaded!</b>"
	end
  --[[*For Debug*
	...
	if matches[1] == 'remlog' and not matches[2] then
		...
		print("<b>Log_SuperGroup "..msg.to.title.."("..msg.to.id..") removed</b>")
		savelog(msg.to.id, name_log.." ["..msg.from.id.."] added Log_SuperGroup")
		logrem(msg)
	end
    return
